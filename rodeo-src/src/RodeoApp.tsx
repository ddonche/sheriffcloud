...
function NoAccessScreen() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#111827", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ textAlign: "center", color: "#6b7280", fontSize: 14 }}>
        <div style={{ fontSize: 32, marginBottom: 12 }}>🔒</div>
        Your account doesn't have access to Rodeo AI.
        <br />
        Redirecting…
      </div>
    </div>
...
function ResetPasswordPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#111827", padding: 20 }}>
      <div style={{ background: "#fff", border: "1px solid #d4d4d8", borderRadius: 8, width: "100%", maxWidth: 400, padding: 24, fontFamily: "system-ui, sans-serif", display: "grid", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
          <img src="/rodeo/rodeologo.png" alt="Rodeo AI" height={28} style={{ display: "block", objectFit: "contain" }} />
    ...
    <header style={{
      ...
      <button
        ...
        style={{
          ...
          gap: 6,
          padding: "6px 12px",
          background: hovering ? "#1f2937" : "transparent",
          border: "1px solid " + (hovering ? "#374151" : "#1f2937"),
          borderRadius: 6,
